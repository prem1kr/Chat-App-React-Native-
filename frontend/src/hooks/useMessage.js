...
export const markAsDelivered = async (messageId) => {
  try {
    ...
    socket.emit("messageDeliveredLocal", {messageId,userId: await AsyncStorage.getItem("userId")});
    return response.data;
...
export const markAsRead = async (messageId) => {
  try {
    ...
    socket.emit("messageReadLocal", {messageId,userId: await AsyncStorage.getItem("userId") });
    return response.data;
...
export const deleteMessage = async (messageId) => {
  try {
    ...
    socket.emit("messageDeletedLocal", { messageId });
    return response.data;
